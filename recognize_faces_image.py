...
"""
example_images = [
    "/home/user/Downloads/test_images/testimage_yalda.jpg",
    "/home/user/Downloads/test_images/testimage_danche.jpg",
    "/home/user/Downloads/test_images/test_pic.jpg",
    "/home/user/Downloads/test_images/test_pic1.jpg",
    "/home/user/Downloads/test_images/test_pic2.jpg",
    "/home/user/Downloads/test_images/test_pic3.jpg"
]
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--image", required=False,
                default=example_images[5],
                help="path to input image")
ap.add_argument("-e", "--encodings-file", required=False, default='/home/user/Downloads/pyimagesearch-face-recognition/encodings/face_training_encodings.pkl',
...
def pipeline_facial(test_image="default"):
    input_image, encodings_file, detection_method = get_command_line_args()
    if test_image != "default":
        input_image = test_image
    
    return run_facial_recognition(input_image, encodings_file, detection_method)


def run_facial_recognition(input_image, encodings_file, detection_method):
