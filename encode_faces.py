...
ap.add_argument("-d", "--dataset", required=False, default="/home/user/Downloads/pyimagesearch-face-recognition/dataset/", help="path to input dataset directory")
ap.add_argument("-e", "--encodings-file", required=False, default='/home/user/Downloads/pyimagesearch-face-recognition/encodings/face_training_encodings.pkl', help="path to serialized db of facial encodings")
